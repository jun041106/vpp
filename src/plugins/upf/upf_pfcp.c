...
static upf_qer_policer_t *init_qer_policer(upf_qer_t *qer)
{
...
static void attach_qer_policer(upf_qer_t *qer)
{
  upf_main_t *gtm = &upf_main;
  upf_qer_policer_t *pol;

  if (qer->policer.key == ~0 ||
      !(qer->flags & SX_QER_MBR))
    return;
...
static void detach_qer_policer(upf_qer_t *qer)
{
  upf_main_t *gtm = &upf_main;
  upf_qer_policer_t *pol;
